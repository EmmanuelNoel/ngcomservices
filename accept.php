...
<body>
    ...
    try{
      ...
      $req = $bdd->prepare('SELECT * FROM stagiaire WHERE id=:id');
...
$re = $bdd->prepare('INSERT INTO demandeaccepte(nom,prenom,adresse,gmail,contact,sexe,ecole,type_stage,departement,dates)
VALUES (:nom,:prenom,:adresse,:gmail,:contact,:type_stage,:sexe,:ecole,:departement,:dates)');
